...
extern uint16_t taskButtonsPeriod;
extern uint16_t taskMotorPeriod;
extern uint16_t taskControlPeriod;
extern uint16_t taskLcdPeriod;

// flag
extern uint8_t flagTaskControl ;
extern uint8_t flagTaskButtons;
extern uint8_t flagTaskMotor;
